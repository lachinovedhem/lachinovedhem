...
I build the systems a retail business actually runs on: enterprise ERP, point of sale with
fiscal compliance, warehouse flow, identity and access, reporting. Roughly 50 production
systems over eight years — most of them still running, most of them closed source.

- 🏭 **Software Architect** at a national grocery retail chain — a platform of 18 internal
